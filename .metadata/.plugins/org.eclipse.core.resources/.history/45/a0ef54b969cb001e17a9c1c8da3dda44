...
public class StudentDao {
	private String dburl = "jdbc:postgresql://localhost:5432/java2";
	private String username = "postgres";
	private String password = "12345";
	private String dbdriver = "org.postgresql.Driver";
	private static final String INSERT_STUDENT_SQL = "INSERT INTO student (name, age, dob, school, code, email, mobile) VALUES (?, ?, ?, ?, ?, ?, ?);";
